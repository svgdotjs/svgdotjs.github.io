...
echo '<!doctype html>'"<html><head><meta http-equiv=\"refresh\" content=\"0; url=./docs/${NEWEST}\"></head><body>You are redirected. If not, click <a href=\"./docs/${NEWEST}\">here</a></body></html>" > index.html
